...
class GraphonGNN(nn.Module):
    ...
    def __init__(self,
        ...
        for GSO in GSOs:
            if count == 0:
                N = GSO.shape[1]
            self.Ss.append(torch.tensor(GSO))
            count = count + 1
        
        self.N = [N] + nSelectedNodes # Number of nodes
        ...
        self.rho = gml.GraphonCoarsening
